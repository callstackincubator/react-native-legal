...
Which can be found in [`ScanPackageOptions.ts`](https://github.com/callstackincubator/react-native-legal/blob/main/packages/licenses-api/src/types/ScanPackageOptions.ts).
