...
- programmatically use the `@callstack/licenses-api` package, which exposes the core functionalities of this tool - see [this section](/docs/programmatic-usage) for more details
