    ...
    graphRenderJobDispatchRef.current = setTimeout(() => {
      ...
      const zoom = d3
        ...
        .on('zoom', function () {
          ...
          // @ts-expect-error -- TS2345 Argument of type 'ZoomTransform' is not assignable to parameter of type ...
          inner.attr('transform', d3.zoomTransform(this));
        });

      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-expect-error -- TS2345 Argument of type 'ZoomBehavior<Element, unknown>' is not assignable to parameter of type  ...
      svg.call(zoom).on('wheel.zoom', (event: WheelEvent) => {
        ...
        if (event.ctrlKey) {
          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          // @ts-expect-error -- TS2345 Argument of type 'Selection<SVGSVGElement | null, unknown, null, undefined>' is not assignable to parameter of type  ...
      ...
      // center the graph
      {
        ...
        svg.call(
          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          // @ts-expect-error -- TS2345 Argument of type '(selection: Selection<Element, unknown, any, any> | TransitionLike<Element, unknown>, transform: ZoomTransform | ((this: Element, event: any, d: unknown) => ZoomTransform), point?: [...] | ... 1 more ... | undefined) => void' is not assignable to parameter of type  ...
          zoom.transform,
          d3.zoomIdentity
            .translate(
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
