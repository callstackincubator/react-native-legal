...
```bash
npm install @callstack/licenses-api
```

## Programmatic Usage

You can use `@callstack/licenses-api` programmatically in your Node.js applications. Here's a basic example of how to use it:
