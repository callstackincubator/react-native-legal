...
```sh
yarn add -D @callstack/licenses-api
```

or

```sh
npm i --save-dev @callstack/licenses-api
```
...
You can use the `@callstack/licenses-api` package to access the core functionalities of the license management tool. To do so, please read the [programmatic usage documentation](https://callstackincubator.github.io/react-native-legal/docs/programmatic-usage#usage).
